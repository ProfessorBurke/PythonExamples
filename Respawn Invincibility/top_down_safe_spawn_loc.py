...
class Student(pygame.sprite.Sprite):
    ...
    def respawn(self) -> None:
        self.rect.topleft = self._spawn_loc
...
def main() -> None:
    ...
    ememy_bricks: pygame.sprite.Group
    
    # Set up assets.
    image_files: list = ["barrier.jpg", "floor.jpg", "floor.jpg"]
    background = Background(image_files, "castle.txt", [0], [2])
    enemy_bricks = pygame.sprite.Group(Background(image_files, "enemies_castle.txt", [0], [2]).get_bricks())
