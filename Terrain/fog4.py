"""
    A flickering flashlight effect.  Built on top of:
...
##        cy_flicker: int = cy + random.randint(-1, 1)
        # Torch
        lr_flicker: int = lr + random.randint(-4, 4)
        cx_flicker: int = cx + random.randint(-2, 2)
        cy_flicker: int = cy + random.randint(-2, 2)
