...
from powerups10 import PowerUp, PowerupFactory, Droppable, DroppableFactory
...
pygame.display.set_caption("Brickout 10.0")
clock = pygame.time.Clock()
...
##    image = pygame.transform.laplacian(screen.copy())
