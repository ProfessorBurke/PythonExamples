"""
    Compare the default blending mode with multiply mode.
...
# Load the city image and create the brown-tinted overlay.
image = pygame.image.load("background.jpg").convert_alpha()  
overlay = pygame.Surface((SIZE, SIZE), pygame.SRCALPHA)
overlay.fill((150, 100, 50, 150))

# Image A: default blend
image_A = image.copy()
image_A.blit(overlay, (0, 0))

# Image B: BLEND_RGB_MULT
image_B = image.copy()
image_B.blit(overlay, (0, 0), special_flags=pygame.BLEND_RGB_MULT)
pygame.image.save(image_B, "brown_mult.png")
...
while running:
    ...
    label_left = font.render("Default Blend", True, (0, 0, 0))
    label_right = font.render("BLEND_RGB_MULT", True, (0, 0, 0))
