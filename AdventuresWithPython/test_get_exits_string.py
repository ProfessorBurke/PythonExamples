import shabby_abbeyv5

"""
    Run an exhaustive set of tests on the get_exits_string function
    in shabby_abbeyv5.
"""

tests: list[list[int]] = [    [1, 1, 1, 1],          # 0: N S E W
                              [1, 1, 1, -1],         # 1: N S E
                              [1, 1, -1, 1],         # 2: N S W
                              [1, 1, -1, -1],        # 3: N S                                    
                              [1, -1, 1, 1],         # 4: N E W
...
for test_num in range(len(tests)):
    exits_str = shabby_abbeyv5.get_exits_string(tests[test_num])
