...
def main() -> None:
    ...
    inv1 = Inventory()
    inv1.from_json({"book": {"name": "book", "description": "a book"},
                    "knife": {"name": "knife", "description": "a nasty knife"},
                    "nest": {"name": "nest", "description": "some avian hard work"}})
    ...
    print("Actual: ")
    item: Item = Item()
    item.from_json({"name": "egg", "description": "A jewel-encrusted egg"})
    inv1.add("egg", item)
    print(inv1)
    ...
    inv2.from_json({"one": {"name":"one", "description":"thing one"},
                    "two":{"name":"two", "description":"thing two"}})
    inv3.from_json({"knife":{"name": 'knife', "description": 'A nasty knife'},
                    "nest":{"name":'nest', "description": 'The result of some avian hard work'}})
    print(inv3)
